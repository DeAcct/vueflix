(window["webpackJsonp"]=window["webpackJsonp"]||[]).push([["chunk-f39ab334"],{"057f":function(t,e,n){var r=n("c6b6"),s=n("fc6a"),i=n("241c").f,o=n("4dae"),a="object"==typeof window&&window&&Object.getOwnPropertyNames?Object.getOwnPropertyNames(window):[],c=function(t){try{return i(t)}catch(e){return o(a)}};t.exports.f=function(t){return a&&"Window"==r(t)?c(t):i(s(t))}},"0829":function(t,e,n){"use strict";(function(t){n.d(e,"a",(function(){return hi})),n.d(e,"b",(function(){return Yi})),n.d(e,"c",(function(){return fi})),n.d(e,"d",(function(){return Ki})),n.d(e,"e",(function(){return Hi}));var r=n("589b"),s=n("22e5"),i=n("e691"),o=n("1fd5"),a=n("8f6b");const c="@firebase/firestore";
/**
 * @license
 ...
 * limitations under the License.
 */
class St{constructor(t,e){this._service=t,this._location=e instanceof U?e:U.makeFromUrl(e,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,e){return new St(t,e)}get root(){const t=new U(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return it(this._location.path)}get storage(){return this._service}get parent(){const t=rt(this._location.path);if(null===t)return null;const e=new U(this._location.bucket,t);return new St(this._service,e)}_throwIfRoot(t){if(""===this._location.path)throw M(t)}}function At(t){t._throwIfRoot("getDownloadURL");const e=bt(t.storage,t._location,ht());return t.storage.makeRequestWithTokens(e,_t).then(t=>{if(null===t)throw x();return t})}function kt(t,e){const n=st(t._location.path,e),r=new U(t._location.bucket,n);return new St(t.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
