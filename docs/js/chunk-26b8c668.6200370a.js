 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve=new Le(et.comparator);function Fe(){return Ve}const qe=new Le(et.comparator);function Be(){return qe}new Le(et.comparator);const Ke=new je(et.comparator);function $e(...t){let e=Ke;for(const n of t)e=e.add(n);return e}const He=new je(x);function Ge(){return He}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kr{constructor(t,e){this.bs={},this.Be=new R(0),this.Ue=!1,this.Ue=!0,this.referenceDelegate=t(this),this.He=new Ar(this),this.Jt=new er,this.Je=function(t,e){return new Sr(t,e)}(this.Jt,t=>this.referenceDelegate.vs(t)),this.k=new Zn(e),this.Ye=new br(this.k)}start(){return Promise.resolve()}shutdown(){return this.Ue=!1,Promise.resolve()}get started(){return this.Ue}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(){return this.Jt}getMutationQueue(t){let e=this.bs[t.toKey()];return e||(e=new Ir(this.Jt,this.referenceDelegate),this.bs[t.toKey()]=e),e}getTargetCache(){return this.He}getRemoteDocumentCache(){return this.Je}getBundleCache(){return this.Ye}runTransaction(t,e,n){f("MemoryPersistence","Starting transaction:",t);const r=new Cr(this.Be.next());return this.referenceDelegate.Vs(),n(r).next(t=>this.referenceDelegate.Ss(r).next(()=>t)).toPromise().then(t=>(r.raiseOnCommittedEvent(),t))}Ds(t,e){return Xn.or(Object.values(this.bs).map(n=>()=>n.containsKey(t,e)))}}class Cr extends Wn{constructor(t){super(),this.currentSequenceNumber=t}}class Or{constructor(t){this.persistence=t,this.Cs=new Er,this.Ns=null}static ks(t){return new Or(t)}get xs(){if(this.Ns)return this.Ns;throw y()}addReference(t,e,n){return this.Cs.addReference(n,e),this.xs.delete(n.toString()),Xn.resolve()}removeReference(t,e,n){return this.Cs.removeReference(n,e),this.xs.add(n.toString()),Xn.resolve()}markPotentiallyOrphaned(t,e){return this.xs.add(e.toString()),Xn.resolve()}removeTarget(t,e){this.Cs.us(e.targetId).forEach(t=>this.xs.add(t.toString()));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next(t=>{t.forEach(t=>this.xs.add(t.toString()))}).next(()=>n.removeTargetData(t,e))}Vs(){this.Ns=new Set}Ss(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Xn.forEach(this.xs,n=>{const r=et.fromPath(n);return this.$s(t,r).next(t=>{t||e.removeEntry(r)})}).next(()=>(this.Ns=null,e.apply(t)))}updateLimboDocument(t,e){return this.$s(t,e).next(t=>{t?this.xs.delete(e.toString()):this.xs.add(e.toString())})}vs(t){return 0}$s(t,e){return Xn.or([()=>Xn.resolve(this.Cs.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Ds(t,e)])}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class _t{constructor(t,e){this._service=t,this._location=e instanceof U?e:U.makeFromUrl(e,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,e){return new _t(t,e)}get root(){const t=new U(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return it(this._location.path)}get storage(){return this._service}get parent(){const t=rt(this._location.path);if(null===t)return null;const e=new U(this._location.bucket,t);return new _t(this._service,e)}_throwIfRoot(t){if(""===this._location.path)throw M(t)}}function At(t){t._throwIfRoot("getDownloadURL");const e=bt(t.storage,t._location,ht());return t.storage.makeRequestWithTokens(e,St).then(t=>{if(null===t)throw x();return t})}function kt(t,e){const n=st(t._location.path,e),r=new U(t._location.bucket,n);return new _t(t.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
